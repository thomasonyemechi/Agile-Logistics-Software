            ...
            <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <h2 class="fw-bold mb-1">
                            {{\App\Models\Freight::sum('pieces')}}
                        </h2>
                        <span class="text-success fw-semi-bold">{{ $freights_approved = \App\Models\FreightApproval::sum('pieces')}}</span>
            ...
            <div class="col-xl-3 col-lg-6 col-md-12 col-12">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <span class="text-success fw-semi-bold">{{$delivered = \App\Models\Delivery::sum('pieces')}}</span>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-4">
                <div class="card h-100">
                  ...
                  justify-content-between card-header-height">
                        <h4 class="mb-0">Recent Manifest</h4>
                        <a href="/control/all/manifest" class="btn btn-outline-white btn-sm">View all</a>
                    </div>
                    @php
                        $freights = \App\Models\Manifest::orderBy('id', 'desc')->limit(10)->get();
                    @endphp
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table mb-0 text-nowrap">
                                ...
                                <tbody>
                                    @php
                                        $manifests = \App\Models\Manifest::orderBy('id', 'desc')->limit(10)->get();
                                    @endphp
